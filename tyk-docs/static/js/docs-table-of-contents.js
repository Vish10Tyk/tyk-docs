...
/* var buildTableOfContents = function () {
    ...
    contentTitles.each(function () {
        ...
        // Add accordion functionality for h2 and h3
        if ($(this).is('h2')) {
            h2 = $(this).text().replace(/[^a-zA-Z0-9]/g, '').toLowerCase();
			...
			// Toggle visibility of H3 elements under this H2
			if($('.accordion-item').hasClass('accordion-content')){				
				accordionHeader.addClass('accordion-remove-icon');
			}
